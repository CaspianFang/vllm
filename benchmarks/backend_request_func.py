...
async def async_request_vllm(
    ...
    async with aiohttp.ClientSession(timeout=AIOHTTP_TIMEOUT) as session:
        # Here we make a piece of paylaod to the server, that is sampling parameters
        # but here we will not pack it. The job of converting dict to sampling parameters
        # will be done at the server side.
        payload = {
