...
async def benchmark(
    ...
    async for request in get_request(input_requests, request_rate):
        ...
        # The prompt len and the output len is randomly sampled from the dataset.
        # for example: 
        # prompt len: 26, output len: 125
        # prompt len: 13, output len: 284
        # prompt len: 161, output len: 522
        # prompt len: 42, output len: 972
