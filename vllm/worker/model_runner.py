...
class ModelRunner:
    ...
    def prepare_input_tensors(
        ...
        seq_group_metadata_list: Optional[List[SequenceGroupMetadata]],
               ...
               Set[int], LoRAMapping | OLoRAMapping]:
        if self.is_driver_worker:
            ...
            if is_prompt:
                if self.lora_config and self.lora_config.enable_olora:
                ...
                if self.lora_config and self.lora_config.enable_olora:
                    ...
                    olora_requests) = self._prepare_olora_decode(seq_group_metadata_list)
                    prompt_lens = []
                    subquery_lens = None
                else:  
                    (input_tokens, input_positions, input_metadata,
    ...
    def execute_model(
        ...
        if self.lora_config and self.lora_config.enable_olora:
            ...
            self.set_active_loras(olora_requests, olora_mapping)
